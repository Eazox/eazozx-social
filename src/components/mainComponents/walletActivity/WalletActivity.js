            ...
            <View style={styles.walletMessage}>
                ...
                <View>
                    <Text style={{
                        ...
                        lineHeight: 22.4,
                        color: "#3B485B"
                    }}>You made a deposit of £32</Text>
                    <Text style={{
                        fontWeight: "400",
                        fontStyle: "normal",
                        fontSize: 12,
                        color: "#A1A8B1"
                    }}>Thursday 24, 2020. 14:50</Text>
                </View>
                <View>
                    <Text style={{
                        color: "#43C780",
            ...
            <View style={styles.walletMessageTwo}>
                ...
                <View>
                    <Text style={{
                        ...
                        lineHeight: 22.4,
                        color: "#3B485B"
                    }}>You made a withdrawal of  £32</Text>
                    <Text style={{
                        fontWeight: "400",
                        fontStyle: "normal",
                        fontSize: 12,
            ...
            <View style={styles.walletMessageThree}>
                ...
                <View>
                    <Text style={{
                        ...
                        left: 7,
                        color: "#3B485B"
                    }}>Your post got rewarded with £32</Text>
                    <Text style={{
                        left: 7, fontWeight: "400",
                        fontStyle: "normal",
                        fontSize: 16,
                        lineHeight: 22.4,
                        color: "#3B485B"
                    }}>by<Text style={{ color: "#578DDE" }}>@Manuelsnr</Text> </Text>
                    <Text style={{
                        fontWeight: "400",
                        fontStyle: "normal",
                        fontSize: 12,
