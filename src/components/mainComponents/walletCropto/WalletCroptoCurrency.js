      ...
      <>
        <View>
          ...
          <View style={styles.WalletCroptoCurrencyText}>
            <Text style={{ fontWeight: '600', fontSize: 18, color: '#3B485B' }}>
              NGN 370,530.20
            </Text>
            ...
            <View style={styles.croptoCurrencyWeek}>
              ...
              >
                <Text
                  style={{ fontSize: 12, fontWeight: '400', fontStyle: 'normal', lineHeight: 16.8 }}
                >
                  +3%
                </Text>
        ...
        <View style={styles.walletActivitiesContainer}>
          ...
          <View style={styles.walletIndicator}>
            <View style={{ borderColor: '#578DDE', borderWidth: 3, width: 100, left: 240 }} />
          </View>
        </View>
