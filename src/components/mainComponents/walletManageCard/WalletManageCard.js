            ...
            >
                <View style={styles.walletManageCardName}>
                    <View style={styles.inputOne}>
                        <Text style={{ fontWeight: "500", fontStyle: "normal", fontSize: 14, color: "#3B485B", bottom: 7 }}>Card Name</Text>
                        <TextInput
                            keyboardType="default"
                            value={cardName}
                            onChangeText={(value) => setCardName(value)}
                            onFocus={() => setEnableShif(false)}
                            placeholder="plase enter your card Name" style={{
                                width: 343,
                                height: 48,
                                borderRadius: 8,
                    ...
                    <View style={styles.inputTwo}>
                        <Text style={{ fontWeight: "500", fontStyle: 'normal', fontSize: 14, color: "#3B485B", bottom: 7 }}>Card Number</Text>
                        <TextInput
                            value={cardNumber}
                            onChangeText={(value) => setCardNumber(value)}
                            keyboardType="numeric"
                            onFocus={() => setEnableShif(false)}
                            placeholder="1234 1234 1234 1234" style={{
                                paddingLeft: 14,
                                width: 343,
                                height: 48,
                                borderRadius: 8,
                        ...
                        <Icons name="credit-card" color="#9BA1AA" size={20} style={{ position: "absolute", left: 300, top: 34 }} />
                    </View>
                </View>

                <View style={styles.walletCardInfo}>
                    <View>
                        <Text style={{ color: "#3B485B", fontWeight: "500", fontStyle: "normal", fontSize: 14, bottom: 7 }} >Expiry Date</Text>
                        <TextInput
                            value={date}
                    ...
                    <View style={{ position: "relative" }}>
                        <Text style={{ color: "#3B485B", fontWeight: "500", fontStyle: "normal", fontSize: 14, bottom: 7 }}>CVV</Text>
                        <TextInput
                            value={cvNumber}
                            keyboardType="numeric"
                            onChangeText={(value) => setCvNumber(value)}
                            keyboardType="numeric"
                            placeholder="_ _ _" style={{
                                height: 48,
                                width: 160,
                                backgroundColor: "#F4F4F4",
                                borderRadius: 8,
                        ...
                        <Icons name="alert-circle" color="#9BA1AA" size={20} style={{
