...
export default function SideNav() {
  ...
  return (
    <View style={styles.container}>
        ...
        <TouchableWithoutFeedback onPress={() => setToggleIcon(!toggleIcon)}>
          {toggleIcon ? (
            <Icons
              ...
              size={20}
              color='#BDBDBD'
              style={{ right: 20, backgroundColor: '#578DDE', borderRadius: 40, width: 30 }}
            />
          ) : (
            <Icons
              name='toggle-left'
              size={20}
              color='#BDBDBD'
              style={{ right: 20, backgroundColor: 'white', borderRadius: 40, width: 30 }}
            />
          )}
        </TouchableWithoutFeedback>
      </View>
      ...
      <View style={{ borderWidth: 1, width: 295, marginTop: 30, borderColor: '#F4F4F4' }} />
