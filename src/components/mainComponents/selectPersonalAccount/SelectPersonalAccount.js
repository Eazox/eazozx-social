        ...
        <View style={styles.selectPersonalAccount}>
            <View style={styles.selectPersonHeader}>
                ...
                <View style={styles.selectPersonContent}>
                    ...
                    }}>You can always switch over later on!</Text>
                </View>
            ...
            <View style={styles.selectPersonalCard}>
                <View style={{ width: 160, height: 173 }}>
                    <Card>
                        <CheckBox checked={personalChecked.personalChecked} onPress={onCheckedChange} color="#578DDE"
                ...
                <View style={{ width: 160, height: 173, }}>
                    <Card>
                        <CheckBox checked={businessChecked.businessChecked} onPress={onBusinessChange} color="#578DDE"
                            style={{ borderRadius: 20, marginTop: 10, left: 120 }} />
            ...
            <View style={styles.personalButton}>
                <TouchableOpacity style={{ backgroundColor: "#15243C", width: 343, height: 48, borderRadius: 48 }}>
                    <Text style={{
                        textAlign: 'center',
                        marginTop: 10,
                        color: "#FFFFFF",
