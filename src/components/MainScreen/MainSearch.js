            ...
            <ScrollView style={styles.MainScreen}>
                ...
                <View style={styles.MainHeader}>
                    ...
                    <View style={styles.MainSearch}>
                        <TouchableOpacity>
                            <Icons name="search" size={19} style={{
                                position: "absolute",
                                top: 10,
                                left: 40,
                                color: '#BDBDBD'
                        ...
                        <TextInput placeholder="Search EAZOX" style={{
                            width: 287,
                            borderWidth: 1.5,
                            borderColor: '#FAFAFA',
                            height: 40,
                ...
                <View style={styles.MainTrend}>
                    ...
                    <Picker
                        ...
                        onValueChange={(itemValue, itemIndex) =>
                            this.setState({ reward: itemValue })
                        }>
                ...
                <View style={{ width: "100%", borderColor: "#BDBDBD", borderWidth: 1, marginTop: 20 }}></View>

                <View style={styles.ShowMore}>
                    <TouchableOpacity>
                        <Text style={{ fontWeight: "400", fontSize: 18, lineHeight: 21.6, fontStyle: 'normal', color: "#578DDE" }}>Show more</Text>
                    </TouchableOpacity>
                    <Text style={{ marginTop: 50, fontWeight: "500", fontSize: 18, color: "#15243C" }}>Did you miss these?</Text>

                    <View style={{ borderWidth: 1, borderColor: '#BDBDBD', alignItems: "center", marginTop: 10 }}></View>
                </View>
                ...
                <View style={styles.FirstUserContainer}>
                    ...
                    <View style={{ padding: 20, borderColor: "#FAFAFA", borderWidth: 1 }}>
                        <Text style={{
                            color: "rgba(10, 26, 50, 0.8)", fontSize: 16,
                            fontStyle: "normal",
                            fontWeight: "400",
                            lineHeight: 19.2
                        }}>The new <Text style={{
                            ...
                            looks so good on me. Y’all should try it out. </Text>

                        <View style={styles.UserList}>
                            <View style={{ flexDirection: "row" }}>
                                <Image source={UserPhone} style={{ width: 24, height: 24, borderRadius: 100, }} />
                                <Image source={UserPhone} style={{ width: 24, height: 24, borderRadius: 100, right: 16 }} />
                                <Image source={UserPhone} style={{ width: 24, height: 24, borderRadius: 100, right: 30 }} />
                            </View>
                            <Text style={{
                                right: 35, color: "#5B6576",
                                fontWeight: "400",
                ...
                <View style={styles.secondUserContainer}>
                    <View style={{ borderWidth: 1, flexDirection: "row", padding: 20, borderColor: "#FAFAFA", justifyContent: "space-between" }}>
                        <Image source={UserPhone} style={{
                            width: 40,
                            height: 40,
                            borderRadius: 100,
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "space-between", padding: 20, borderWidth: 1, borderColor: "#FAFAFA" }}>
                        <View style={{ flexDirection: "row" }}>
                            <TouchableOpacity>
                                <Icons name="heart" size={18} color="#BDBDBD" />
                            </TouchableOpacity>
                ...
                <View style={styles.thrirdUserContainer}>
                    ...
                    <View style={{ padding: 20, borderColor: "#FAFAFA", borderWidth: 1 }}>
                        <Text style={{ color: "rgba(10, 26, 50, 0.8)" }}>The new <Text style={{ color: "#578DDE" }}>#BelganBelt</Text> looks so good on me. Y’all should try it out. </Text>
                        <View style={styles.UserList}>
                            <View style={{ flexDirection: "row" }}>
                                <Image source={UserPhone} style={{ width: 24, height: 24, borderRadius: 100, }} />
                                <Image source={UserPhone} style={{ width: 24, height: 24, borderRadius: 100, right: 16 }} />
