        ...
        return (
            <View style={styles.container}>
              ...
              <View style={styles.inputText}>
                  ...
                  />
                    <Text style={{color: "red", marginLeft: 20, fontSize: 10}}>{this.state.emailError}</Text>
              </View>
           ...
           <View style={styles.textPassword}>
              ...
              <Text style={{color: "red", marginLeft: 20, fontSize: 10}}>{this.state.passwordError}</Text>
              ...
              <View style={styles.facebookContainer}>
                 <TouchableOpacity style={styles.facebookContent}>
                  ...
                  <Text style={{ marginTop: 10, textAlign: 'center',  marginLeft:10, color: "#FFFFFF"}}>Continue with Facebook</Text>
                </TouchableOpacity>  
              </View>
                 
                 
                <View style={{ textAlign: "center", flexDirection: 'row', marginLeft: 80, marginTop:10}}>
                    <Text style={{fontWeight: '600', fontStyle: 'normal', fontSize: 16, lineHeight: 24, color: "#939090"  }}>Don’t have an account?</Text>
                    <TouchableOpacity>
                      <Text style={{fontWeight: '600', fontStyle: 'normal', fontSize: 16, lineHeight: 24, color: '#3B5998', marginBottom: 30  }}> Sign Up</Text>
                    </TouchableOpacity>
